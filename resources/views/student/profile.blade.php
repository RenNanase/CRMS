                    ...
                    <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                        <div class="p-6">
                            <div class="flex flex-col items-center">
                                ...
                                <div class="relative">
                                    <img src="{{ asset('storage/' . (Str::contains($student->photo, '/') ? $student->photo : 'profile_photos/' . $student->photo)) }}"
                                        alt="Profile Picture"
                                ...
                                <p class="text-teal-600 font-medium">{{ $student->matric_number }}</p>
                            </div>

                            <div class="mt-6 flex justify-center">
                                <a href="{{ route('student.profile.edit', ['id' => $student->id]) }}"
                    ...
                    <div class="bg-white rounded-2xl shadow-sm">
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-start">
                                            <svg class="h-5 w-5 text-teal-500 mr-2 mt-0.5" fill="none"
                                ...
                                <div class="space-y-6">
<!-- Replace the existing program display with this -->
<div>
    <h4 class="text-sm font-medium text-gray-500 mb-1">Programme</h4>
    <div class="flex items-center">
            ...
            @endif
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <p class="text-gray-900">{{ $student->academic_year }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-8 p-4 bg-teal-50 rounded-xl">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-teal-600">Last updated: {{ $student->updated_at->format('d
                                        M Y, h:i A') }}</span>
                                </div>
                            </div>
                        </div>
