...
<head>
    ...
    <title>Rejected Enrollments Management</title>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-teal-500">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800">{{ $rejectedEnrollments->total() }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-teal-500">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800">{{ $rejectedEnrollments->where('created_at', '>=', now()->startOfMonth())->count() }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-teal-500">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-gray-500 text-sm">Rejected Rate</p>
        ...
        <div class="bg-white shadow-xl rounded-lg overflow-hidden">
            <div class="bg-gradient-to-r from-teal-500 to-teal-600 p-6">
                <div class="flex justify-between items-center">
                    <h1 class="text-2xl font-bold text-white">Rejected Enrollments</h1>
                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        <div>
                            <p class="text-sm text-gray-700">
                                Showing
                                <span class="font-medium">{{ $rejectedEnrollments->firstItem() }}</span>
                                to
                                <span class="font-medium">{{ $rejectedEnrollments->lastItem() }}</span>
                                of
                                <span class="font-medium">{{ $rejectedEnrollments->total() }}</span>
                                results
                            </p>
                        </div>
                        <div>
